        ...
        <div class="row">
            <div class="col-md-3">
              <div class="list-group list-group-flush ">
                 <a href="studentserviceclearanceform.php" class="list-group-item">
                 <i class="fas fa-tachometer-alt"></i> Dashboard
                 </a>   
            
                 <a href="studentserviceclearanceform.php" class="list-group-item active"><i class="fab fa-wpforms"></i> Students Clearance Form</a> 
                <a href="" class="list-group-item "><i class="far fa-clipboard"></i>  Students Records </a>  
                    ...
                    <?php foreach($registration_data as $students):?>
                            ...
                            <td><?= $students->department?></td>
                                ...
                                <td>
                                    ...
                                    <a href="studentserviceedit.php?id=<?=$students->id ?>"
