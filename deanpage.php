        ...
        <div class="row">
            <div class="col-md-3  ">
              <div class="list-group list-group-flush" id="navbarNavDropdown" >
                 <a href="deanpage.php" class="list-group-item active">
                 <i class="fas fa-tachometer-alt"></i>Dashboard
                 </a>   
                 <a href="deanclearanceform.php" class="list-group-item list-group-item-action"><i class="fab fa-wpforms"></i>Clearance Form</a> 
