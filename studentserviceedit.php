<?php
 ...
 if (isset($_POST['firstname'])&& isset($_POST['surname']) && isset($_POST['other_name']) && isset($_POST['reg_no']) && isset($_POST['department'])){
    ...
    $studentservice = $_POST['studentservice'];
    $reason = $_POST['reason'];
  
 $sql='UPDATE students_registration_data SET firstname=:firstname, surname=:surname, other_name=:other_name, reg_no=:reg_no, department=:department,  studentservice=:studentservice WHERE id=:id';
 $statement = $connection->prepare($sql);
 if($statement->execute([':firstname'=>$firstname, ':surname'=>$surname, ':other_name'=>$other_name, ':reg_no'=>$reg_no, ':department'=>$department, ':studentservice'=>$studentservice ." ".  $reason,':id'=>$id])){
 
 header("location: studentserviceclearanceform.php");
         ...
         <form method="post">
          <div class="card-title">
            ...
            <label for="firstname">Firstame</label>
                <input type="text"  name="firstname"   value="<?=$students->firstname; ?>" id="firstname" class="form-control">
            </div>

     <div class="form-group">
        <label for="surname">Surname</label>
        <input type="text" name="surname"   value="<?=$students->surname; ?>" id="surname" class="form-control">
    </div>

     <div class="form-group">
        <label for="other_name">Other Name</label>
        <input type="text" name="other_name"   value="<?=$students->other_name; ?>"  id="other_name" class="form-control">
    </div>

     <div class="form-group">
        <label for="reg_no">Registration No</label>
        <input type="text" name="reg_no"      value="<?=$students->reg_no; ?>" id="reg_no" class="form-control">
    </div>

    <div class="form-group">
        <label for="department">Department</label>
        <input type="text" name="department"    value="<?=$students->department; ?>" id="department" class="form-control">
    </div>
     
     <div class="form-group">
     <label>Students Service</label>
        <select id="Studentservice" class="form-control" name="studentservice" autofocus>
...
if($('#Studentservice').val() === 'uncleared')   
   {   
   $('#Uncleared').show();    
   }   
else 
