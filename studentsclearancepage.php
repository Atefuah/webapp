...
<section >
    ...
    <ol class="breadcrumb bg-primary">
        ...
        <li class="breadcrumb-item active text-white "> Students Clearance Form</li>
    </ol>
    </div>
    </section>
    <section>
        ...
        <div class="row">
            <div class="col-md-3">
              <div class="list-group list-group-flush ">
                 <a href="librarymain.php" class="list-group-item">
                 ...
                 <a  class="list-group-item dropdown-toggle" href="" data-toggle="dropdown" data-toggle="collapse" > About</a> 
                 <ul class="dropdown-menu">
  <li><a href="aboutschool.php" class="list-group-item list-group-item-action  small"><i class="far fa-clipboard"></i> About School</a></li>
  <li><a href="aboutclearance.php" class="list-group-item list-group-item-action  small"><i class="far fa-clipboard"></i>  About Clearance</a></li>
 </ul>
...
<div class="card bg-light">
               ...
               <table class="table  table-bordered  " >
                    ...
                    <?php foreach($registration_data as $students):?>
                            ...
                            <td> 
                              <a href="edit.php?id=<?= $students->id ?>" class="btn btn-info btn-sm "><i class="far fa-file-alt"></i> fill form</a>   
                            </td>
                            </tr>
             <?php endforeach;?>
                        </tbody>
